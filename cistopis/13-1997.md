...
#### § 8 — Průjezdní úsek dálnice a silnice  `[272 Čl.XXVII/1]` {uc=A}

(1) Dálnice a silnice mohou vést ~~zastavěným~~ **zastavitelným** územím ~~nebo zastavitelnými plochami~~ (dále jen „průjezdní úsek dálnice“ nebo „průjezdní úsek silnice“), pokud se tím převádí převážně průjezdná doprava tímto územím. {uc=A}

(2) Prováděcí předpis stanoví stavebně technické podmínky pro určování hranic průjezdního úseku podle předchozího odstavce.

#### § 11 — Silniční pozemek  `[272 Čl.XXVII/2; 272 Čl.XXVII/3]` {uc=A}
...
#### § 18g — Posouzení stavby a její dokumentace  `[272 Čl.XXVII/4]` {uc=A}
...
d) úsek silnice II. nebo III. třídy, na jehož výstavbu, rekonstrukci nebo opravu byly nebo mají být využity prostředky Evropské unie, s výjimkou úseku nacházejícího se v ~~zastavěném~~ **zastavitelném** území. {uc=A}
...
#### § 24 — Omezení obecného užívání uzavírkami a objížďkami  `[272 Čl.XXVII/4]` {uc=A}
...
b) s obcí, na jejímž ~~zastavěném~~ **zastavitelném** území má být povolena uzavírka nebo nařízena objížďka, {uc=A}
...
#### § 25 — Zvláštní užívání  `[272 Čl.XXVII/5]` {uc=A}
...
1. sloužit k označení provozovny nacházející se v ~~zastavěném~~ **zastavitelném** území ve vzdálenosti do 50 metrů od reklamního zařízení nebo mimo ~~zastavěné~~ **zastavitelné** území v silničním ochranném pásmu ve vzdálenosti do 200 metrů od reklamního zařízení, nebo {uc=A}
...
(2) V ~~zastavěném~~ **zastavitelném** území jsou místní komunikace a průjezdní úsek silnice schůdné, jestliže umožňují bezpečný pohyb chodců, kterým je pohyb přizpůsobený stavebnímu stavu a dopravně technickému stavu těchto komunikací a povětrnostním situacím a jejich důsledkům. {uc=A}
...
#### § 30  `[272 Čl.XXVII/4; 272 Čl.XXVII/6; 272 Čl.XXVII/7]` {uc=A}
...
(2) Silničním ochranným pásmem se pro účely tohoto zákona rozumí prostor mimo ~~zastavěné~~ **zastavitelné** území ohraničený svislými plochami vedenými do výšky 50 m a ve vzdálenosti {uc=A}
...
(3) S ohledem na vymezení ~~zastavěného~~ **zastavitelného** území může být ochranné pásmo zřízeno pouze po jedné straně dálnice, silnice nebo místní komunikace I. a II. třídy. {uc=A}
...
(5) Pro zřizování a provozování reklamních zařízení se silničním ochranným pásmem dálnice rozumí také prostor v ~~zastavěném~~ **zastavitelném** území ohraničený svislými plochami vedenými do výšky 50 m a ve vzdálenosti 50 m od osy přilehlého jízdního pásu dálnice nebo od osy větve její křižovatky s jinou pozemní komunikací. {uc=A}

#### § 35 — Ochrana dálnice, silnice a místní komunikace  `[272 Čl.XXVII/4]` {uc=A}
...
#### § 37 — Styk s dráhami  `[272 Čl.XXVII/4]` {uc=A}
...
b) opatření na přejezdu v ~~zastavěném~~ **zastavitelném** území, aby chodci při přechodu dráhy nebyli nuceni používat vozovky silnice nebo místní komunikace, {uc=A}
...
#### § 40 — Výkon státní správy  `[272 Čl.XXVII/8]` {uc=A}
...
a) ~~Dopravní a energetický stavební úřad~~ **Úřad rozvoje území České republiky**, jde-li o připojení týkající se dálnice nebo úpravy či zrušení takového připojení, {uc=A}
