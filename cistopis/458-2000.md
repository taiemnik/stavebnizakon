...
Ustanovení dotčená senátním tiskem **272/0** (Čl. XLIII, Čl. XLIV). Nezměněná ustanovení tohoto zákona **nejsou** uvedena. Rušený text ~~škrtnutý~~, nový text **tučně** (slovní diff). Pracovní artefakt — ověř proti PDF.

---

#### § 2 — Vymezení pojmů  `[272 Čl.XLIII/1; 272 Čl.XLIII/2]` {uc=A}
...
4. elektrizační soustavou vzájemně propojený soubor zařízení pro výrobu, přenos, transformaci, ukládání a distribuci elektřiny, včetně **vývodových vedení** elektrických přípojek, přímých vedení, a systémy měřicí, ochranné, řídicí, zabezpečovací, informační a telekomunikační techniky, a to na území České republiky, {uc=A}
...
#### § 3 — Podnikání v energetických odvětvích  `[272 Čl.XLIII/3]` {uc=A}
...
#### § 3a — Souhlas s nabytím vlivu nad energeticky strategickým celkem  `[272 Čl.XLIII/4]` {uc=A}

(1) Ministerstvo ~~průmyslu a obchodu~~ **hospodářství** (dále jen „ministerstvo“) rozhoduje o udělení souhlasu s nabytím vlivu nad energeticky strategickým celkem. Nabytí vlivu nad energeticky strategickým celkem bez souhlasu ministerstva je zakázáno. Česká republika se může dovolat neplatnosti právního jednání, kterým došlo k nabytí vlivu nad energeticky strategickým celkem bez souhlasu ministerstva. {uc=A}
...
**(5) Požádá-li držitel licence v případě licence, jejíž platnost končí uplynutím 25 let od doby jejího udělení, nejpozději 30 dní před uplynutím doby, na kterou byla licence udělena, o udělení nové licence ve vztahu k energetickým zařízením provozovaným na základě této licence, licence zaniká až právní mocí rozhodnutí Energetického regulačního úřadu o nové žádosti.** {uc=A}

#### § 10c  `[272 Čl.XLIII/6]` {uc=A}
...
#### § 17 — Energetický regulační úřad a jeho působnost  `[272 Čl.XLIII/7]` {uc=A}
...
9. ve spolupráci s ~~Ministerstvem pro místní rozvoj~~ **Úřadem rozvoje území České republiky** a Ministerstvem pro životní prostředí dobu trvání povolovacího postupu pro zařízení na výrobu energie z obnovitelných zdrojů, jakož i jejich připojení k soustavě, včetně posouzení vlivů na životní prostředí, {uc=A}
...
#### § 17b — Organizace Energetického regulačního úřadu  `[272 Čl.XLIII/4; 272 Čl.XLIII/9; 272 Čl.XLIII/10; 272 Čl.XLIII/11; 272 Čl.XLIII/12; 272 Čl.XLIII/13; 272 Čl.XLIII/14]` {uc=A}

(1) Rada Energetického regulačního úřadu (dále jen „Rada“) má ~~5 členů~~ **3 členy**, z nichž 1 je předseda Energetického regulačního úřadu. {uc=A}

(2) Předsedu Energetického regulačního úřadu a další členy Rady jmenuje a odvolává vláda na návrh ministra ~~průmyslu a obchodu~~ **hospodářství**. Člen Rady je jmenován na ~~5~~ **6** let a jeho funkční období začíná vždy dnem 1. ledna. Členové Rady jsou jmenováni tak, že ~~každý rok~~ **každé dva roky** je jmenován jeden člen Rady. Nikdo nemůže být členem Rady jmenován více než dvakrát; do počtu jmenování se nezapočítává jmenování podle ~~odstavců~~ **odstavce** 10 ~~a 11~~. {uc=A}
...
(6) Funkce člena Rady je neslučitelná s funkcí poslance nebo senátora, soudce, státního zástupce, jakoukoliv funkcí ve veřejné správě, s funkcí člena orgánů územní samosprávy a s členstvím v politické straně nebo v politickém hnutí. **Předseda Energetického regulačního úřadu musí být držitelem platného osvědčení fyzické osoby pro stupeň utajení Důvěrné nebo vyšší. Není-li držitelem osvědčení podle věty druhé, požádá bez zbytečného odkladu po svém jmenování do funkce o vydání tohoto osvědčení podle zákona upravujícího ochranu utajovaných informací74).** {uc=A}
...
~~(12)~~ **(11)** Funkce předsedy Energetického regulačního úřadu zaniká v okamžiku zániku jeho funkce člena Rady, jeho odstoupením nebo jeho odvoláním vládou z funkce předsedy Energetického regulačního úřadu. **Nezíská-li předseda Energetického regulačního úřadu osvědčení podle odstavce 6 věty třetí nebo dojde-li k zániku platnosti tohoto osvědčení, ministr průmyslu a obchodu bezodkladně navrhne vládě odvolání předsedy Energetického regulačního úřadu z jeho funkce.** Ministr průmyslu a obchodu bezodkladně navrhne vládě jmenovat nového předsedu Energetického regulačního úřadu. {uc=A}

~~(13)~~ **(12)** Rada rozhoduje hlasováním. Každý člen Rady má jeden hlas. Rozhodnutí Rady je přijato, pokud pro něj hlasovali alespoň ~~3~~ **2** její členové. O hlasování se vede protokol, který podepisují všichni přítomní členové Rady a osoba, která byla pověřena sepsáním protokolu; při nahlížení do spisu je vyloučeno nahlížet do tohoto protokolu. {uc=A}
...
**(10) Navrhuje-li se změna metodiky cenové regulace v průběhu regulačního období, Energetický regulační úřad zveřejní návrh změny na svých internetových stránkách a stanoví lhůtu pro podání připomínek veřejnosti, která nesmí být kratší než 30 dnů. Energetický regulační úřad umožní podávání připomínek prostřednictvím diskusního místa podle odstavce** {uc=A}

**3. Zveřejnění návrhu změny metodiky cenové regulace Energetický regulační úřad oznámí osobám podle odstavce 9, vyzve je k uplatnění připomínek a stanoví lhůtu pro jejich podání, která nesmí být kratší než 30 dnů. K připomínkám podaným po stanovené lhůtě se nepřihlíží.** {uc=A}

~~(10)~~ **(11)** K projednání připomínek veřejnosti a subjektů podle odstavců 8 a 9 uspořádá Energetický regulační úřad do 30 dnů po uplynutí lhůt pro podání připomínek veřejné projednání. Informaci o místu a čase konání veřejného projednání Energetický regulační úřad zveřejní na svých internetových stránkách nejméně 14 dnů před jeho konáním. Veřejného projednání se mohou účastnit subjekty uvedené v odstavcích 8 a 9 a ten, kdo ve stanovené lhůtě podal k návrhu metodiky cenové regulace připomínky. O průběhu veřejného projednání vede Energetický regulační úřad písemný záznam. {uc=A}

~~(11)~~ **(12)** Po veřejném projednání připomínek provede Energetický regulační úřad písemné vypořádání připomínek podaných k návrhu metodiky cenové regulace a zveřejní jej včetně jeho odůvodnění na svých internetových stránkách do 30 dnů od uskutečnění veřejného projednání. Součástí písemného vypořádání připomínek je písemný záznam o průběhu veřejného projednání. {uc=A}

~~(12)~~ **(13)** Energetický regulační úřad je povinen cenové výměry vydávané podle tohoto zákona, s výjimkou věcně usměrňovaných cen tepelné energie, vydat nejpozději do 30. listopadu roku předcházejícího roku, pro který v cenovém výměru Energetický regulační úřad regulované ceny stanoví. Cenové výměry týkající se věcně usměrňovaných cen tepelné energie a regulovaných cen podle zákona o podporovaných zdrojích energie je Energetický regulační úřad povinen vydat nejpozději do 30. září roku předcházejícího roku, pro který v cenovém výměru Energetický regulační úřad regulované ceny stanoví. {uc=A}

#### § 18 — Dozor v energetických odvětvích  `[272 Čl.XLIII/16]` {uc=A}
...
**(9) Cenu za kapacitní mechanismus reguluje Energetický regulační úřad tak, aby pokrývala alespoň ekonomicky oprávněné náklady provozovatele přenosové soustavy na zajištění kapacitního mechanismu. Cenu za kapacitní mechanismus stanoví Energetický regulační úřad pro regulované roky nebo i část regulovaného roku, ve kterém bude poskytován sjednaný rozsah dostupnosti výkonu. V případě potřeby změny ceny za kapacitní mechanismus v průběhu regulovaného roku stanoví Energetický regulační úřad cenu za kapacitní mechanismus do 3 měsíců ode dne poskytnutí údajů pro stanovení ceny za kapacitní mechanismus operátorem trhu a provozovatelem přenosové soustavy.** {uc=A}

~~(9)~~ **(10)** Metodika cenové regulace stanoví postupy regulace cen související služby v elektroenergetice a související služby v plynárenství pro regulační období a způsoby stanovení cen pro provozovatele přenosové soustavy, provozovatele přepravní soustavy, provozovatele distribuční soustavy, povinně vykupujícího, datového centra a operátora trhu. Energetický regulační úřad zpracovává metodiku cenové regulace vždy pro každé regulační období tak, aby vytvořil podmínky pro transparentní, předvídatelné a dlouhodobě stabilní investiční prostředí v odvětví elektroenergetiky a plynárenství. {uc=A}

~~(10)~~ **(11)** Rozhodl-li soud o zrušení cenového výměru nebo jeho části, nastávají účinky rozsudku soudu k 1. lednu následujícího kalendářního roku. Energetický regulační úřad promítne regulační rozdíl vzniklý uplatňováním cen nebo postupů podle zrušeného cenového výměru nebo jeho části v cenách stanovených pro následující regulovaný rok, případně pro více následujících regulovaných roků. {uc=A}

#### § 19cb  `[272 Čl.XLIII/20]` {uc=A}

**Cena za kapacitní mechanismus Cenu za kapacitní mechanismus hradí účastníci trhu s elektřinou provozovateli přenosové soustavy v ceně za související služby v elektroenergetice přímo nebo prostřednictvím provozovatele regionální distribuční soustavy.** {uc=A}

#### § 20a — Operátor trhu  `[272 Čl.XLIII/21; 272 Čl.XLIII/22]` {uc=A}
...
za) sestavovat a zveřejňovat ~~národní energetický mix a~~ zbytkový energetický mix, {uc=A}
...
#### § 22 — Účastníci trhu s elektřinou  `[272 Čl.XLIII/17]` {uc=A}
...
(3) Účastník trhu s elektřinou je povinen hradit cenu za systémové služby**, cenu za kapacitní mechanismus**, cenu za provoz nesíťové infrastruktury a složku ceny na podporu elektřiny z podporovaných zdrojů energie podle zákona o podporovaných zdrojích energie i v případě, kdy není uzavřena smlouva o zajištění služby distribuční soustavy, využívá-li k odběru elektřiny jím provozovanou distribuční soustavu. {uc=A}

#### § 23 — Výrobce elektřiny  `[272 Čl.XLIII/23]` {uc=A}
...
r) splnit požadavky na bezpečnou instalaci **podle technické normy upravující požární bezpečnost staveb75)** v případě výroben elektřiny ~~z obnovitelných zdrojů energie~~ **využívajících energii slunečního záření** s instalovaným výkonem do 100 kW připojených k distribuční soustavě, které nevyžadují povolení záměru podle stavebního zákona, {uc=A}
...
#### § 25 — Provozovatel distribuční soustavy  `[272 Čl.XLIII/24]` {uc=A}
...
c) zpracovávat a předávat ~~ministerstvu a~~ Energetickému regulačnímu úřadu jednou ročně nejpozději do 1. března následujícího kalendářního roku zprávu o kvalitě a úrovni údržby zařízení distribuční soustavy, {uc=A}
...
#### § 27da — Povinnosti datového centra při zohledňování aktivace flexibility a ukládání elektřiny  `[272 Čl.XLIII/25]` {uc=A}
...
5. subjektu zúčtování naměřené a vyhodnocené údaje o dodávkách a odběrech elektřiny a naměřené a vyhodnocené údaje o dodávkách a odběrech elektřiny se zohledněním aktivace flexibility **a ukládání elektřiny** v předávacím místě účastníka trhu s elektřinou ~~poskytujícího flexibilitu~~, ve kterém převzal odpovědnost za odchylku dodávky nebo odběru elektřiny nebo flexibility v době její aktivace, {uc=A}
...
#### § 30a — Výstavba výrobny elektřiny  `[272 Čl.XLIII/26; 272 Čl.XLIII/27]` {uc=A}

(1) Výstavba výrobny elektřiny o celkovém instalovaném elektrickém výkonu ~~1~~ **100** MW a více je možná pouze na základě udělené státní autorizace na výstavbu výrobny elektřiny (dále jen „autorizace“). Za celkový instalovaný elektrický výkon výrobny elektřiny se považuje součet hodnot instalovaných výkonů výrobních jednotek v místě připojení do elektrizační soustavy. {uc=A}
...
c) s územně plánovací dokumentací, **ledaže předpokládaná výrobna elektřiny je stavbou pro energetickou bezpečnost podle zákona upravujícího urychlení výstavby strategicky významné infrastruktury,** {uc=A}
...
#### § 35 — Kapacitní mechanismus  `[272 Čl.XLIII/28; 272 Čl.XLIII/29; 272 Čl.XLIII/30; 272 Čl.XLIII/31; 272 Čl.XLIII/32]` {uc=A}

(1) Ministerstvo může za podmínek a postupem podle ~~čl. 21~~ Nařízení o vnitřním trhu s elektřinou vydat opatření obecné povahy, kterým zavede kapacitní mechanismus a stanoví podmínky účasti v kapacitním mechanismu, dobu trvání a další podmínky kapacitního mechanismu ~~podle čl. 22 Nařízení o vnitřním~~ **a uloží účastníkům** trhu s elektřinou **povinnosti v souvislosti se zavedením kapacitního mechanismu**. {uc=A}

**(2) Ministerstvo stanoví opatřením obecné povahy podle odstavce 1 po projednání s Energetickým regulačním úřadem rovněž způsob určení rozsahu potřebné dostupnosti výkonu výroben elektřiny nebo jiných energetických zařízení.** {uc=A}

~~(2)~~ **(3)** Provozovatel přenosové soustavy je povinen poskytnout ministerstvu nezbytnou součinnost při stanovení podmínek kapacitního mechanismu. {uc=A}

~~(3)~~ **(4)** Rozsah potřebné dostupnosti ~~regulačního~~ výkonu výroben elektřiny nebo jiných energetických zařízení určuje za podmínek stanovených ministerstvem provozovatel přenosové soustavy **a předloží ho ministerstvu ke schválení**. {uc=A}

~~(4)~~ **(5)** Provozovatel přenosové soustavy zpracuje návrh postupu a podmínek zajištění potřebné dostupnosti ~~regulačního~~ výkonu výroben elektřiny nebo jiných energetických zařízení **v aukci** a předloží ho ministerstvu ke schválení. {uc=A}

~~(5)~~ **(6)** Ministerstvo **rozsah potřebné dostupnosti výkonu výroben elektřiny nebo jiných energetických zařízení podle odstavce 4 a** návrh podle odstavce ~~4~~ **5** schválí, jestliže ~~je~~ **jsou** v souladu s podmínkami kapacitního mechanismu stanovenými ministerstvem. **Před schválením si ministerstvo může vyžádat vyjádření Energetického regulačního úřadu.** {uc=A}

~~(6)~~ **(7)** Ministerstvo opatření obecné povahy změní nebo zruší, pokud se změní nebo zaniknou důvody pro zavedení kapacitního mechanismu. {uc=A}

#### § 35a — **Provádění kapacitního mechanismu**  `[272 Čl.XLIII/33]` {uc=A}

**(1) Provozovatel přenosové soustavy je povinen zajišťovat potřebnou dostupnost výkonu výroben elektřiny nebo jiných energetických zařízení v souladu s postupem a podmínkami zajištění potřebné dostupnosti výkonu výroben elektřiny nebo jiných energetických zařízení v aukci a v souladu s podmínkami kapacitního mechanismu stanovenými ministerstvem.** {uc=A}

**(2) Provozovatel přenosové soustavy má právo zrušit aukci na zajištění potřebné dostupnosti výkonu výroben elektřiny nebo jiných energetických zařízení jen se souhlasem ministerstva.** {uc=A}

**(3) Provozovatel přenosové soustavy má právo přistoupit k uzavření smluv o zajištění potřebné dostupnosti výkonu s předkladateli nabídek, které uspěly v aukci na zajištění potřebné dostupnosti výkonu výroben elektřiny nebo jiných energetických zařízení, jen se souhlasem ministerstva.** {uc=A}

#### § 45 — Elektrická přípojka  `[272 Čl.XLIII/34; 272 Čl.XLIII/36]` {uc=A}
...
a) v ~~zastavěném~~ **zastavitelném** území podle zvláštního právního předpisu4d)**, je-li její délka do 50 m včetně,** provozovatel distribuční soustavy, {uc=A}

b) mimo ~~zastavěné~~ **zastavitelné** území podle zvláštního právního předpisu4d), je-li její délka do 50 m včetně, provozovatel distribuční soustavy, {uc=A}

c) mimo ~~zastavěné~~ **zastavitelné** území podle zvláštního právního předpisu4d), je-li její délka nad 50 m, žadatel o připojení. {uc=A}
...
#### § 47 — Přeložky zařízení  `[272 Čl.XLIII/37]` {uc=A}
...
(2) Přeložku zařízení přenosové soustavy nebo zařízení distribuční soustavy zajišťuje provozovatel přenosové soustavy nebo provozovatel distribuční soustavy na náklady toho, kdo potřebu přeložky vyvolal, není-li dohodnuto jinak. V ~~zastavěném~~ **zastavitelném** území podle zvláštního právního předpisu4d) nese náklady na provedení přeložky zařízení nízkého napětí provozovatel distribuční soustavy, pokud provedení přeložky vyplývá z rozhodnutí o odstranění stavby, na níž je zařízení distribuční soustavy umístěno, nebo technický stav zařízení distribuční soustavy nedovoluje jeho bezpečné provozování nebo poškozuje stavbu, pokud vlastník zařízení distribuční soustavy nezajistí nápravu. {uc=A}
...
#### § 50 — Smlouvy mezi účastníky trhu s elektřinou  `[272 Čl.XLIII/38]` {uc=A}
...
**(14) Smlouvou o zajištění potřebné dostupnosti výkonu se účastník kapacitního mechanismu zavazuje poskytovat provozovateli přenosové soustavy dostupnost výkonu a provozovatel přenosové soustavy se zavazuje zaplatit účastníkovi kapacitního mechanismu cenu.** {uc=A}

~~(14)~~ **(15)** Pokud smlouva uzavřená podle odstavců 1, 2, 5 a 7 neobsahuje některou ze stanovených náležitostí, považuje se za platnou, pokud se zákazník nedovolá její neplatnosti. {uc=A}

~~(15)~~ **(16)** Závazek poskytovat služby údržby odběrných elektrických zařízení nebo elektrické přípojky nebo jiné obdobné služby zaniká se zánikem závazku dodávat elektřinu ze smlouvy o dodávce elektřiny nebo smlouvy o sdružených službách dodávky elektřiny, ledaže se strany dohodnou jinak. {uc=A}

~~(16)~~ **(17)** Nedostatek písemné formy smlouvy podle odstavců 1, 2 a 10 může namítat jen spotřebitel. {uc=A}

#### § 68 — Ochranná pásma  `[272 Čl.XLIII/39; 272 Čl.XLIII/40; 272 Čl.XLIII/41]` {uc=A}
...
a) u plynovodů ~~a~~**,** plynovodních přípojek o tlakové úrovni do 4 bar včetně **s výjimkou regulačních stanic**, umístěných v ~~zastavěném~~ **zastavitelném** území obce 1 m na obě strany a umístěných mimo ~~zastavěné~~ **zastavitelné** území obce 2 m na obě strany, {uc=A}
...
d) u technologických objektů **o tlakové úrovni nad 4 bary a regulačních stanic o tlakové úrovni do 4 bar včetně** 4 m na každou stranu od objektu, {uc=A}
...
h) u vlastní telekomunikační sítě držitele licence umístěné v ~~zastavěném~~ **zastavitelném** území obce 0,5 m na obě strany a umístěné mimo ~~zastavěné~~ **zastavitelné** území obce 1 m na obě strany. {uc=A}
...
#### § 79 — ~~Tepelná přípojka a předávací stanice~~ **Tepelná přípojka, předávací stanice a tepelná síť**  `[272 Čl.XLIII/42; 272 Čl.XLIII/43; 272 Čl.XLIII/44]` {uc=A}
...
#### § 91 — Přestupky držitele licence  `[272 Čl.XLIII/45; 272 Čl.XLIII/46; 272 Čl.XLIII/47; 272 Čl.XLIII/48; 272 Čl.XLIII/49]` {uc=A}
...
r) dodává elektřinu ~~nebo~~ plyn před nabytím účinnosti smlouvy v rozporu s § 11ca odst. 3, ~~nebo~~ {uc=A}
...
s) nezcizí zařízení podle § 25b odst. 9, ~~nebo~~ {uc=A}
...
i) neuvedl ve vyúčtování dodávek plynu podíl plynu vyrobeného v daném období z obnovitelných zdrojů energie podle § 61 odst. 1 písm. h),

j) zvýší cenu za dodávku plynu sjednanou se zákazníkem v rozporu s § 73h odst. 1,

k) neoznámí uveřejnění zvýšení ceny za dodávku plynu nebo nedoloží způsob zohlednění změny nákladů na koupi plynu v době trvání stavu nouze Energetickému regulačnímu úřadu podle § 73h odst. 3,

l) poruší některou z povinností uvedených v § 19e odst. 5,

m) nesjedná se zákazníkem smlouvu podle § 19g odst. 1,

n) vyúčtuje zákazníkovi dodávku plynu za cenu vyšší než sjednanou nebo změněnou podle § 11a odst. 4,

o) nezveřejní nebo neoznámí Energetickému regulačnímu úřadu hodnotu indexu zajištění obchodníka podle § 61 odst. 2 písm. q) nebo ji stanoví v nesprávné výši,

p) neuvede ve vyúčtování dodávek plynu podíl plynu z obnovitelných zdrojů a nízkouhlíkového plynu nebo tento podíl nedoloží zárukami původu plynu z obnovitelných zdrojů a nízkouhlíkového plynu podle § 61 odst. 2 písm. s), nebo

q) neposkytne zákazníkovi potvrzení o zárukách původu plynu z obnovitelných zdrojů a nízkouhlíkového plynu uplatněných k dodávce plynu do jeho odběrného místa podle § 61 odst. 2 písm. t).
...
b) 50 000 000 Kč nebo 1 % z čistého obratu dosaženého držitelem licence za poslední ukončené účetní období, jde-li o přestupek uvedený v odstavci 1 písm. o) **nebo t)**, odstavci 2, odstavci 3 písm. a), c), e) až l) ~~nebo~~**,** n) až s**) nebo u**), odstavci 4 až 6, odstavci 7 písm. a), c), e) až p) nebo s) nebo odstavci 9 až 11, 14 nebo 16, {uc=A}
...
#### § 91a — Přestupky právnických a podnikajících fyzických osob  `[272 Čl.XLIII/50; 272 Čl.XLIII/51; 272 Čl.XLIII/52]` {uc=A}
...
l) neposkytne údaje podle § 33 odst. 4, ~~nebo~~ {uc=A}
...
(9) Za přestupek uvedený v odstavcích 1 až 4, 7 nebo 8 lze uložit pokutu do 15 000 000 Kč s výjimkou přestupku podle odstavce 1 písm. v) a odstavce 2 písm. k) **nebo n)**, kdy lze uložit pokutu až do 50 000 000 Kč**, a** s výjimkou přestupku podle odstavce 2 písm. f) nebo g), kdy lze uložit pokutu až do výše 1 000 000 Kč. Za přestupek uvedený v odstavci 5 nebo odstavci 6 písm. j) lze uložit pokutu až do výše 1 000 000 Kč. Za přestupek uvedený v odstavci 6 písm. a), b) nebo i) lze uložit pokutu až do výše 50 000 000 Kč. {uc=A}
...
#### § 97b — Věcná břemena k nemovitostem ve vlastnictví státu, státní příspěvkové organizace, státního fondu a státního podniku  `[272 Čl.XLIII/53; 272 Čl.XLIII/54; 272 Čl.XLIII/55; 272 Čl.XLIII/56]` {uc=A}

(1) Držiteli licence provozujícímu příslušnou soustavu v elektroenergetice zřizovanou a provozovanou ve veřejném zájmu ~~a držiteli licence na výrobu elektřiny provozujícímu výrobnu~~ **stavebníkovi, jemuž bylo vydáno pravomocné rozhodnutí o povolení záměru umožňující umístit stavbu vývodového vedení výrobny** elektřiny z obnovitelných zdrojů energie ~~zřizovanou~~ **zřizované** a ~~provozovanou~~ **provozované** ve veřejném zájmu **nebo vývodového vedení zařízení pro ukládání elektřiny zřizovaného a provozovaného ve veřejném zájmu,** vzniká právní mocí rozhodnutí o povolení záměru umožňujícího umístit stavbu a zařízení příslušné soustavy nebo ~~výrobny elektřiny~~ **stavbu příslušného vývodového vedení** na nemovitostech ve vlastnictví České republiky, státní příspěvkové organizace, státního fondu, státní organizace nebo státního podniku věcné břemeno v rozsahu nezbytném pro výkon věcného břemene opravňujícího zřizovat a provozovat na nemovitostech stavbu nebo zařízení příslušné soustavy ~~nebo výrobny elektřiny~~ a s nimi související stavby a zařízení **nebo stavbu příslušného vývodového vedení**. {uc=A}

(2) V případě, že jsou nemovitosti podle odstavce 1 evidované v katastru nemovitostí, podá oprávněný z věcného břemene bez zbytečného odkladu po nabytí právní moci rozhodnutí o povolení záměru návrh na zápis upozornění k těmto nemovitostem do katastru nemovitostí o tom, že bylo vydáno rozhodnutí o povolení záměru. Návrh na vklad věcného břemene do katastru nemovitostí podá oprávněný z věcného břemene bez zbytečného odkladu po právní moci kolaudačního rozhodnutí pro stavbu nebo zařízení příslušné soustavy nebo ~~výrobny elektřiny~~ **stavbu příslušného vývodového vedení**, nevyžaduje-li předmětná stavba nebo zařízení příslušné soustavy nebo ~~výrobny elektřiny~~ **stavba příslušného vývodového vedení** vydání kolaudačního rozhodnutí, pak bez zbytečného odkladu po dokončení stavby nebo zařízení příslušné soustavy nebo ~~výrobny elektřiny~~ **stavby příslušného vývodového vedení**; společně s podáním návrhu na výmaz upozornění podle ~~předchozí~~ věty **první**. {uc=A}
...
(5) Věcné břemeno zaniká uplynutím 5 let od jeho vzniku, pokud nedojde k zahájení stavby nebo zařízení příslušné soustavy nebo ~~výrobny elektřiny~~ **stavby příslušného vývodového vedení** na nemovitosti podle odstavce 1, a dále v případě trvalého odstranění stavby nebo zařízení příslušné soustavy nebo ~~výrobny elektřiny~~ **stavby příslušného vývodového vedení** z nemovitosti podle odstavce 1. Oprávněný z věcného břemene zajistí bez zbytečného odkladu výmaz věcného břemene z katastru nemovitostí. {uc=A}

~~(6) Oprávněným z věcného břemene podle odstavce 1 je i stavebník, jemuž bylo vydáno pravomocné povolení záměru umožňujícího umístit stavbu nebo zařízení výrobny elektřiny z obnovitelných zdrojů energie zřizované a provozované ve veřejném zájmu na nemovitostech podle odstavce 1.~~ {uc=A}

~~(7)~~ **(6)** Věcná břemena podle odstavce 1 vznikají i na stavbách ve vlastnictví osob uvedených v odstavci 1, které nejsou součástí pozemku. {uc=A}

~~(8)~~ **(7)** Ustanovení tohoto zákona týkající se práv a povinností z věcných břemen se použijí na věcná břemena podle tohoto ustanovení obdobně. {uc=A}

#### § 98a — Zmocňovací ustanovení  `[272 Čl.XLIII/57; 272 Čl.XLIII/58; 272 Čl.XLIII/59]` {uc=A}
...
i) pravidla pro sestavení ~~národního energetického mixu a~~ zbytkového energetického mixu, {uc=A}
...
~~k)~~ **j)** vzor žádosti o souhlas s nabytím vlivu nad energeticky strategickým celkem.
...
**1.** Délka funkčního období členů Rady Energetického regulačního úřadu a předsedy Energetického regulačního úřadu jmenovaných přede dnem nabytí účinnosti tohoto zákona se řídí zákonem č. 458/2000 Sb., ve znění účinném do dne nabytí účinnosti tohoto zákona.

**2.** Funkční období člena Rady Energetického regulačního úřadu jmenovaného do funkce ode dne 1. ledna 2028 končí dnem 31. prosince 2032.

**3.** Právní povaha tepelné přípojky, předávací stanice nebo tepelné sítě zřízených před nabytím účinnosti tohoto zákona, jakož i vznik a trvání právních poměrů týkajících se těchto tepelných zařízení, se posuzují podle zákona č. 458/2000 Sb., ve znění účinném ode dne nabytí účinnosti tohoto zákona.

**4.** Řízení zahájená přede dnem nabytí účinnosti tohoto zákona se dokončí podle zákona č. 458/2000 Sb., ve znění účinném přede dnem nabytí účinnosti tohoto zákona.

**5.** Předseda Energetického regulačního úřadu vykonávající funkci ke dni nabytí účinnosti tohoto zákona je povinen splnit požadavek podle § 17b odst. 6 věty druhé zákona č. 458/2000 Sb., ve znění účinném ode dne nabytí účinnosti tohoto zákona, nejpozději do 6 měsíců ode dne nabytí účinnosti tohoto zákona.
...
- `272 Čl.XLIII/18` V § 19a odst. 4 se věty druhá a třetí nahrazují větami „Věcné usměrňování ceny tepelné energie se nevztahuje na stanovení ceny nižší, než je limitní cena, jejíž výši a po
