...
Ustanovení dotčená senátním tiskem **272/0** (Čl. LXXIII). Nezměněná ustanovení tohoto zákona **nejsou** uvedena. Rušený text ~~škrtnutý~~, nový text **tučně** (slovní diff). Pracovní artefakt — ověř proti PDF.

---

#### § 18 — Předpokládaná hodnota veřejné zakázky rozdělené na části  `[272 Čl.LXXIII/1]` {uc=A}
...
#### § 19 — Předpokládaná hodnota veřejných zakázek pravidelné povahy  `[272 Čl.LXXIII/2]` {uc=A}
...
**(3) Za dodávky nebo služby stejného druhu se považují po sobě jdoucí dodávky nebo služby zajišťované za stejným účelem stejným okruhem dodavatelů s obdobnou specializací, na jejichž výběr zadavatel použije obdobná kvalifikační a hodnotící kritéria.** {uc=A}

~~(3)~~ **(4)** Za veřejné zakázky podle odstavce 1 se nepovažují veřejné zakázky, {uc=A}
...
#### § 30 — Výjimky pro podlimitní veřejné zakázky  `[272 Čl.LXXIII/3; 272 Čl.LXXIII/4]` {uc=A}
...
p) zadávanou příjemcem podpory od veřejného zadavatele na dodávky ~~nebo~~ služby související s podporou práce s dětmi a mládeží, ~~nebo~~ {uc=A}

q) na dodávky nebo služby zadávanou dodavateli se statusem integračního sociálního podniku~~.~~**,** {uc=A}

**r) zadanou na základě plánovací smlouvy podle stavebního zákona58),** {uc=A}

**s) jde-li o provedení nařízeného opatření k nápravě stavebním úřadem podle stavebního zákona59),** {uc=A}

**t) zadávanou společenství podle energetického zákona60) jeho členem za účelem souvisejícím se zajišťováním jeho energetických potřeb, nebo** {uc=A}

**u) jejímž předmětem je sdílení elektřiny členem společenství podle energetického zákona60) tomuto společenství, sdílení elektřiny členem společenství podle energetického zákona60) jinému členu tohoto společenství nebo sdílení elektřiny zákazníkovi mimo společenství. _________________** {uc=A}

---

#### Poznámky pod čarou

32) § ~~157~~ **166** zákona č. ~~183/2006~~ **283/2021** Sb., ~~o územním plánování a stavebním řádu (~~ stavební zákon~~)~~, ve znění pozdějších předpisů.  
**58) § 130 zákona č. 283/2021 Sb., stavební zákon, ve znění pozdějších předpisů.**  
**59) § 296 zákona č. 283/2021 Sb., stavební zákon, ve znění pozdějších předpisů.**  
**60) Zákon č. 458/2000 Sb., o podmínkách podnikání a o výkonu státní správy v energetických odvětvích a o změně některých zákonů (energetický zákon), ve znění pozdějších předpisů.**  
