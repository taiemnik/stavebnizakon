...
Ustanovení dotčená senátním tiskem **272/0** (Čl. LXVI, Čl. LXVII). Nezměněná ustanovení tohoto zákona **nejsou** uvedena. Rušený text ~~škrtnutý~~, nový text **tučně** (slovní diff). Pracovní artefakt — ověř proti PDF.

---

#### § 22b — Předmět poplatku  `[272 Čl.LXVI/1]` {uc=A}

(1) Předmětem poplatku je elektřina vyrobená ve výrobně elektřiny využívající energii větru, jedná-li se o výrobnu elektřiny, která byla záměrem, pro jehož uskutečnění stavební zákon vyžadoval povolení záměru, a toto povolení záměru nabylo právní moci po ~~nabytí účinnosti tohoto zákona~~ **31**. **prosinci 2025.** {uc=A}
...
#### § 22d — Sazba a výpočet poplatku  `[272 Čl.LXVI/2; 272 Čl.LXVI/3]` {uc=A}
...
**(5) Poplatek se snižuje o částku peněžitého plnění, které poplatník poplatku v poplatkovém období poskytl obci na základě plánovací smlouvy nebo jiného právního jednání v souvislosti s uskutečněním záměru, bylo-li toto plnění v tomto období splatné. Poplatek se snižuje o výši poskytnutého peněžitého plnění, a to maximálně do částky odpovídající poplatku určenému podle odstavce 2.** {uc=A}

~~(5)~~ **(6)** Je-li výrobna elektřiny umístěna na katastrálních územích více obcí, ~~které podle odstavce 4 stanovily jiné výše koeficientů poplatků,~~ vypočte se **dílčí** výše poplatku**, a to** podle množství elektřiny tvořící základ poplatku vyrobené ve výrobních zdrojích podle jejich umístění na jednotlivých katastrálních územích obcí a výše koeficientu poplatku. **Dílčí výše poplatku vypočtená podle věty první se snižuje o výši peněžitého plnění poskytnutého obci poplatníkem poplatku postupem podle odstavce 5.** {uc=A}

#### § 22g — Určení poplatku  `[272 Čl.LXVI/4]` {uc=A}
...
(2) Pokud je výrobna elektřiny umístěna na katastrálních územích více obcí, výnos z poplatku v části připadající obcím se rozdělí podle poměru ~~instalovaného výkonu výrobních zdrojů umístěných na katastrálních územích obcí~~ **dílčích výší poplatků, případně snížených postupem podle § 22d odst**. **5 a 6.** {uc=A}
...
#### § 26e — Účinná soustava zásobování tepelnou energií  `[272 Čl.LXVI/5; 272 Čl.LXVI/6]` {uc=A}
...
(2) Účinnou soustavou zásobování tepelnou energií je také soustava zásobování tepelnou energií, ve které množství emisí skleníkových plynů na jednotku tepelné energie ~~dodané zákazníkům~~ **vstupující ze zdrojů do soustavy zásobování tepelnou energií** nepřesáhlo v kalendářním roce v období od {uc=A}
...
(3) Způsob stanovení **podílu tepelné energie z obnovitelných zdrojů, odpadního tepla, kombinované výroby elektřiny a tepla a vysokoúčinné kombinované výroby elektřiny a tepla a** množství emisí skleníkových plynů na jednotku tepelné energie ~~dodané zákazníkům v soustavě~~ **vstupující ze zdrojů do soustavy zásobování tepelnou energií pro účely posouzení účinné soustavy** zásobování tepelnou energií stanoví prováděcí právní předpis. {uc=A}
...
#### § 27be — Rozhodnutí o udělení nebo neudělení práva na podporu z aukce  `[272 Čl.LXVI/7; 272 Čl.LXVI/8]` {uc=A}
...
a) předkladatel nabídky uvede ve lhůtě stanovené v rozhodnutí o udělení práva na podporu z aukce do provozu výrobnu biometanu, jejíž energetický výkon je nejvýše o 20 % nižší nebo ~~je~~ vyšší než energetický výkon výrobny biometanu podle její identifikace v rozhodnutí o udělení práva na podporu z aukce, {uc=A}
...
#### § 29  `[272 Čl.LXVI/9; 272 Čl.LXVI/10; 272 Čl.LXVI/11]` {uc=A}

(1) O poskytnutí dotace operátorovi trhu na úhradu nákladů na podporu elektřiny, provozní podporu tepla, přechodnou transformační podporu tepla a podporu biometanu podle § 28 odst. 3 ~~zákona~~ rozhodne ministerstvo nejpozději do 30 dnů ode dne schválení usnesení podle § 28 odst. 3 ~~zákona~~. O poskytnutí dotace vydá ministerstvo rozhodnutí. Ministerstvo poukáže operátorovi trhu vždy ~~jednu čtvrtinu částky dotace, a to~~ do konce **daného kalendářního** měsíce ~~následujícího po ukončení čtvrtletí~~ **částku odpovídající procentnímu podílu, který je stanoven podílem skutečně vynaložených nákladů operátora trhu na podporu elektřiny, provozní podporu tepla, přechodnou transformační podporu tepla a podporu biometanu podle § 28 odst**. **10 za daný měsíc kalendářního roku předcházejícího kalendářnímu roku, ve kterém vláda stanoví svým usnesením prostředky státního rozpočtu pro poskytnutí dotace podle § 28 odst. 3 a celkové výše skutečně vynaložených nákladů operátora trhu na podporu elektřiny, provozní podporu tepla, přechodnou transformační podporu tepla a podporu biometanu podle § 28 odst. 10 v roce předcházejícím kalendářnímu roku, ve kterém vláda stanoví svým usnesením prostředky státního rozpočtu pro poskytnutí dotace podle § 28 odst. 3.** {uc=A}

(2) Dojde-li v průběhu roku ke změně výše peněžních prostředků určených na poskytnutí dotace podle § 28 odst. 3, ministerstvo upraví rozhodnutí podle odstavce 1 a upravenou částku peněžních prostředků určených na poskytnutí dotace zohlední ve zbývajících ~~čtvrtletních~~ **měsíčních** splátkách dotace. {uc=A}

#### § 45a — ~~Omezení vydání záruky původu energie~~ **Omezení vydání záruky původu energie**  `[272 Čl.LXVI/12]` {uc=A}
...
#### § 45d — ~~Nakládání se zárukami původu energie vydanými v jiném státě nebo převedenými do jiného státu~~ **Nakládání se zárukami původu energie vydanými v jiném členském státě nebo převedenými do jiného členského státu**  `[272 Čl.LXVI/13; 272 Čl.LXVI/14; 272 Čl.LXVI/15]` {uc=A}
...
b) je umožněn elektronický převod záruky původu energie z evidence záruk původu energie z tohoto **jiného** členského státu do evidence záruk původu energie provozované operátorem trhu a {uc=A}

c) ~~žadatel o převod záruky původu energie prokazatelně doloží, že~~ nedošlo k uplatnění záruky původu energie v tomto **jiném** členském státě nebo k jejímu vyřazení. {uc=A}
...
#### § 47d — Povinnost zajistit minimální množství pokročilého biometanu a obnovitelných paliv nebiologického původu za kalendářní rok  `[272 Čl.LXVI/16; 272 Čl.LXVI/18; 272 Čl.LXVI/19; 272 Čl.LXVI/20]` {uc=A}
...
b) 1, ~~5~~ **25** % energetických od 1. ledna 2027 do 31. prosince 2027, {uc=A}

c) 2~~,5~~ % energetických od 1. ledna 2028 do 31. prosince 2028, {uc=A}

d) 3, ~~75~~ **50** % energetických od 1. ledna 2029 do 31. prosince 2029, {uc=A}
...
b) ~~byl nebo bylo~~ **byla** na daňovém území České republiky ~~spotřebován nebo spotřebováno,~~ **spotřebována** a {uc=A}

c) ~~nebyl nebo nebylo zohledněn nebo zohledněno~~ **nebyla zohledněna** pro ~~účely splnění povinnosti uvedené v odstavci 1 ani ke splnění povinnosti zajistit minimální množství pokročilého biometanu a obnovitelných paliv nebiologického původu na území jiného členského státu nebo ke splnění povinnosti zajistit minimální množství pokročilého biometanu a obnovitelných paliv nebiologického původu jiným členským státem, přičemž k prokázání této skutečnosti předkládá dodavatel plynných pohonných hmot čestné prohlášení vydané osobou, která je oprávněna vydat doklad o splnění kritérií udržitelnosti a úspor emisí skleníkových plynů.~~ {uc=A}

**1. účely splnění povinnosti uvedené v odstavci 1 jiným dodavatelem plynných pohonných hmot,** {uc=A}

**2. účely započtení do zbytkového energetického mixu,** {uc=A}

**3. plnění cílů podle čl. 3 a 25 směrnice o podpoře využívání energie z obnovitelných zdrojů na území jiného státu.** {uc=A}

**(4) K prokázání skutečnosti uvedené v odstavci 3 předkládá dodavatel plynných pohonných hmot v případě** {uc=A}

**a) obnovitelných paliv nebiologického původu čestné prohlášení vydané osobou, která je oprávněna vydat doklad o splnění kritérií udržitelnosti a úspor emisí skleníkových plynů, nebo** {uc=A}

**b) pokročilého biometanu uplatněné záruky původu biometanu; pokud se jedná o záruky původu biometanu převedené z jiného státu, musí splňovat podmínky § 45d a biometan musí být evidován v databázi Evropské unie, pokud tato databáze bude toto evidování umožňovat.** {uc=A}

~~(4)~~ **(5)** V případě, že dodavatel plynných pohonných hmot překročí v kalendářním roce povinné minimální množství pokročilého biometanu a obnovitelných paliv nebiologického původu stanovené v odstavci 1, může toto nadměrné množství převést do plnění povinnosti podle odstavce 1 v následujícím kalendářním roce. Množství pokročilého biometanu a obnovitelných paliv nebiologického původu převáděné do následujícího kalendářního roku může činit nejvýše 0,2 % z celkového množství jím dodaných plynných pohonných hmot v uplynulém kalendářním roce. {uc=A}

~~(5)~~ **(6)** Pokud dodavatel plynných pohonných hmot hodlá v následujícím kalendářním roce uplatnit nadměrné množství pokročilého biometanu a obnovitelných paliv nebiologického původu podle odstavce 4, je povinen to písemně sdělit Inspekci ve lhůtě stanovené v § 47dd odst. 2 pro podání zprávy o emisích podle § 20 odst. 7 zákona o ochraně ovzduší. Sdělení musí obsahovat {uc=A}
...
~~(6)~~ **(7)** Osoba odebírající plynné pohonné hmoty do čerpací stanice nebo výdejní jednotky je povinna {uc=A}
...
#### § 47db — Povinnost snižování emisí skleníkových plynů z plynných pohonných hmot za kalendářní rok  `[272 Čl.LXVI/21]` {uc=A}
...
b) 6, ~~75~~ **50** % od 1. ledna 2027 do 31. prosince 2027, {uc=A}

c) 7~~,5~~ % od 1. ledna 2028 do 31. prosince 2028, {uc=A}

d) 8~~,75~~ % od 1. ledna 2029 do 31. prosince 2029, {uc=A}
...
#### § 47e — Kredity  `[272 Čl.LXVI/23]` {uc=A}
...
(20) Osoba odebírající plynné pohonné hmoty se dopustí přestupku tím, že poruší některou z povinností podle § 47d odst. ~~6~~ **7**. {uc=A}
...
- `272 Čl.LXVI/17` V § 47d odst. 3 písm. a) bodě 1 se část věty za středníkem včetně středníku zrušuje.
- `272 Čl.LXVI/22` V § 47db odst. 3 písm. f) se část věty za středníkem včetně středníku zrušuje.
- `272 Čl.LXVI/33` V § 53 odst. 1 písmeno ae) zní: „ae) způsob stanovení podílu tepelné energie z obnovitelných zdrojů, odpadního tepla, kombinované výroby elektřiny a tepla a vysokoúčinné 
