...
#### § 31 — Výkon státního požárního dozoru  `[272 Čl.V/8]`
...
3. dokumentace ~~pro rámcové povolení~~ **nebo jiného podkladu ke změně v účelu užívání stavby**,
...
**(8) Při kontrolách podle odstavce 1 písm. a) a g) postupují orgány vykonávající státní požární dozor podle kontrolního řádu.**
