...
h) oprávnění vystupovat jako účastník v ~~těch~~ řízeních~~, v nichž se vydává územní rozhodnutí, společné~~ **o** povolení~~, kterým se stavba umisťuje a povoluje, nebo dodatečné povolení stavby územní rozhodnutí nahrazující~~ **záměru** podle zvláštního právního předpisu6b) v území městské části.
