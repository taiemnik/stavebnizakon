...
#### § 13 — Využití výsledků geologických prací při územním plánování  `[272 Čl.XIII/1]` {uc=A}
...
~~(5) Jedná-li se o záměr vyžadující jednotné environmentální stanovisko23), vyjádření podle § 13 odst. 3 se nevydává.~~ {uc=A}
