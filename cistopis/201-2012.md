...
b) ~~závazné stanovisko~~ **vyjádření** k povolení záměru obsahujícího stacionární zdroj uvedený v příloze č. 2 k tomuto zákonu k řízením podle jiného právního předpisu46),

c) povolení provozu stacionárního zdroje (dále jen „povolení provozu“) a

d) ~~závazné stanovisko~~ **vyjádření** k povolení záměru pozemní komunikace kategorie dálnice nebo silnice I. třídy v ~~zastavěném~~ **zastavitelném** území obce a parkoviště s kapacitou nad 500 parkovacích stání (dále jen „pozemní komunikace nebo parkoviště“) k řízení podle jiného právního předpisu47).
...
(9) K žádosti o vydání ~~závazného stanoviska~~ **vyjádření** podle odstavce 2 písm. b), jehož předmětem je záměr obsahující spalovací stacionární zdroj o jmenovitém elektrickém výkonu 300 MW a vyšším, je žadatel povinen přiložit odůvodněné posouzení splnění následujících podmínek:
...
(3) ~~Závazné stanovisko~~ **Vyjádření** podle § 11 odst. 2 písm. b) nebo d) může obsahovat ~~podmínky~~ **návrh podmínek** umístění a provedení záměru obsahujícího stacionární zdroj uvedený v příloze č. 2 nebo záměru pozemní komunikace nebo parkoviště zajišťující ochranu ovzduší.
...
(4) Na návrh žadatele o ~~závazné stanovisko~~ **vyjádření, povolení záměru** nebo povolení provozu, nebo při vydávání stanoviska může v odůvodněných případech orgán ochrany ovzduší stanovit, že se minimální vzdálenosti neuplatní.
...
f) provést kompenzační opatření uplatněná ~~krajským úřadem~~ **správním orgánem příslušným k povolení záměru** podle § 11 odst. 4 nebo obsažená v uzavřené veřejnoprávní smlouvě podle § 11 odst. 6,
...
#### § 19f — Povinnost zajistit minimální množství pokročilých biopaliv a obnovitelných paliv nebiologického původu za kalendářní rok
...
e) podaných žádostech o ~~závazné stanovisko~~ **vyjádření** podle § 11 odst. 2 písm. b), žádostech o povolení provozu a žádostech o vydání rozhodnutí podle § 13a po dobu 15 dnů,

f) ~~závazných stanoviscích~~ **vyjádřeních** vydaných podle § 11 odst. 2 písm. b), povoleních provozu a rozhodnutích podle § 13a po dobu 15 dnů,
...
#### § 40 — Společná ustanovení  `[272 Čl.LXVIII/25]`
...
( ~~3~~ **2** ) Povolení provozu podle § 11 odst. 2 písm. c) se nevydá podle tohoto zákona, pokud je jeho vydání nahrazeno postupem v řízení o vydání integrovaného povolení podle jiného právního předpisu28). Ostatní ustanovení tohoto zákona tím nejsou dotčena.

( ~~4~~ **3** ) Práva a povinnosti vyplývající z rozhodnutí vydaných podle tohoto zákona provozovateli přecházejí na právní nástupce provozovatele.

( ~~5~~ **4** ) Ustanovení tohoto zákona a jeho prováděcích právních předpisů stanovující technické požadavky a další podmínky vztahující se na výrobky podle jiného právního předpisu jsou technickými předpisy podle tohoto jiného právního předpisu12).

( ~~6~~ **5** ) Na zařazování do Přechodného národního plánu a vyřazování z Přechodného národního plánu podle § 37 se nevztahuje správní řád.
