...
Ustanovení dotčená senátním tiskem **272/0** (Čl. LXVIII, Čl. LXIX). Nezměněná ustanovení tohoto zákona **nejsou** uvedena. Rušený text ~~škrtnutý~~, nový text **tučně** (slovní diff). Pracovní artefakt — ověř proti PDF.

---

#### § 3 — Přípustná úroveň znečištění  `[272 Čl.LXVIII/1]` {uc=A}

(1) Imisní limity jsou uvedeny v příloze č. 1 k tomuto zákonu. Imisní limity jsou závazné pro orgány ochrany ovzduší při výkonu jejich působnosti podle tohoto zákona**, pro stavební úřady při výkonu působnosti podle jiného právního předpisu** a pro obce a kraje při výkonu jejich samostatné působnosti s dopadem na ovzduší. Imisní limity a úroveň znečištění znečišťujícími látkami, které mají stanoven imisní limit v bodech 1 až 3 přílohy č. 1 k tomuto zákonu jsou podkladem při pořizování územně analytických podkladů a územně plánovací dokumentace. {uc=A}
...
#### § 11  `[272 Čl.LXVIII/2; 272 Čl.LXVIII/3; 272 Čl.LXVIII/4; 272 Čl.LXVIII/5; 272 Čl.LXVIII/6; 272 Čl.LXVIII/7]` {uc=A}
...
b) ~~závazné stanovisko~~ **vyjádření** k povolení záměru obsahujícího stacionární zdroj uvedený v příloze č. 2 k tomuto zákonu k řízením podle jiného právního předpisu46), {uc=A}

c) povolení provozu stacionárního zdroje (dále jen „povolení provozu“) a

d) ~~závazné stanovisko~~ **vyjádření** k povolení záměru pozemní komunikace kategorie dálnice nebo silnice I. třídy v ~~zastavěném~~ **zastavitelném** území obce a parkoviště s kapacitou nad 500 parkovacích stání (dále jen „pozemní komunikace nebo parkoviště“) k řízení podle jiného právního předpisu47). {uc=A}

(3) Zasahuje-li záměr pozemní komunikace nebo parkoviště na území více krajů, je k vydání ~~závazného stanoviska~~ **vyjádření** podle odstavce 2 písm. d) příslušný krajský úřad kraje, v jehož správním obvodu se nachází větší část záměru v ~~zastavěném~~ **zastavitelném** území, nedohodnou-li se krajské úřady jinak. ~~Krajský úřad příslušný k vydání závazného stanoviska si v takovém případě vždy vyžádá vyjádření krajského úřadu, v jehož správním obvodu se nachází část záměru v zastavěném území.~~ {uc=A}

(4) Pokud by provozem stacionárního zdroje označeného ve sloupci B v příloze č. 2 k tomuto zákonu nebo vlivem umístění pozemní komunikace nebo parkoviště podle odstavce 2 písm. d) došlo v oblasti jejich vlivu na úroveň znečištění k překročení některého z imisních limitů s dobou průměrování 1 kalendářní rok uvedeného v bodech 1 a 3 přílohy č. 1 k tomuto zákonu nebo je jeho hodnota v této oblasti již překročena, lze vydat ~~souhlasné závazné stanovisko podle odstavce 2 písm. b) nebo d)~~ **povolení záměru** pouze při současném uplatnění opatření zajišťujících alespoň zachování dosavadní úrovně znečištění pro danou znečišťující látku (dále jen „kompenzační opatření“). ~~Souhlasné závazné stanovisko podle odstavce 2 písm. b) nebo d)~~ **Povolení záměru** lze v odůvodněných případech vydat i bez uplatnění kompenzačních opatření, je-li zřejmé, že provoz stacionárního zdroje, pozemní komunikace nebo parkoviště by měly pouze zanedbatelný vliv na úroveň znečištění pro danou znečišťující látku. {uc=A}
...
(3) ~~Závazné stanovisko~~ **Vyjádření** podle § 11 odst. 2 písm. b) nebo d) může obsahovat ~~podmínky~~ **návrh podmínek** umístění a provedení záměru obsahujícího stacionární zdroj uvedený v příloze č. 2 nebo záměru pozemní komunikace nebo parkoviště zajišťující ochranu ovzduší. {uc=A}
...
#### § 12a — Minimální vzdálenosti  `[272 Čl.LXVIII/12; 272 Čl.LXVIII/13]` {uc=A}

(1) Orgány ochrany ovzduší za účelem ochrany ovzduší při vydávání stanoviska, ~~závazného stanoviska~~ **vyjádření, povolení záměru** a povolení provozu též vycházejí z minimálních vzdáleností mezi stacionárním zdrojem uvedeným v příloze č. 2a k tomuto zákonu, který znečišťuje nebo by mohl znečišťovat tuhými znečišťujícími látkami nebo látkami obtěžujícími zápachem a pro který je minimální vzdálenost stanovena prováděcím právním předpisem, a stanovenými plochami vymezenými v územním plánu, s výjimkou {uc=A}
...
(4) Na návrh žadatele o ~~závazné stanovisko~~ **vyjádření, povolení záměru** nebo povolení provozu, nebo při vydávání stanoviska může v odůvodněných případech orgán ochrany ovzduší stanovit, že se minimální vzdálenosti neuplatní. {uc=A}
...
#### § 16 — Povinnosti osob  `[272 Čl.LXVIII/14]` {uc=A}
...
#### § 17 — Povinnosti provozovatele stacionárního zdroje  `[272 Čl.LXVIII/15]` {uc=A}
...
f) provést kompenzační opatření uplatněná ~~krajským úřadem~~ **správním orgánem příslušným k povolení záměru** podle § 11 odst. 4 nebo obsažená v uzavřené veřejnoprávní smlouvě podle § 11 odst. 6, {uc=A}
...
#### § 19f — Povinnost zajistit minimální množství pokročilých biopaliv a obnovitelných paliv nebiologického původu za kalendářní rok  `[272 Čl.LXVIII/16]` {uc=A}
...
#### § 26  `[272 Čl.LXVIII/19; 272 Čl.LXVIII/20]` {uc=A}
...
d) obecní úřad obce s rozšířenou působností, jde-li o přestupky podle § 25 odst. 1 písm. e), i), ~~j),~~ l), o), p), t), u), w) ~~nebo~~ x), ~~nebo~~ přestupky podle § 25 odst. 1 písm. f), g), m), q), r), s) ~~nebo~~ § 25 odst. 2 písm. d), jsou-li spáchány v souvislosti s provozem stacionárního zdroje neuvedeného v příloze č. 2 k tomuto zákonu, ~~nebo~~ {uc=A}
...
#### § 27 — Orgány ochrany ovzduší vykonávající správní činnosti na úseku ochrany ovzduší  `[272 Čl.LXVIII/21; 272 Čl.LXVIII/22]` {uc=A}
...
**g) orgány státní báňské správy,**

~~f)~~ **h)** obecní úřady obcí s rozšířenou působností,

~~g)~~ **i)** obecní úřady,

~~h)~~ **j)** celní úřady a

~~i)~~ **k)** Ministerstvo zemědělství.
...
(5) Inspekce, Česká obchodní inspekce, krajský úřad**, stavební úřad, orgán státní báňské správy**, obecní úřad obce s rozšířenou působností a celní úřad v rozsahu své působnosti dozírají na dodržování ustanovení tohoto zákona a předpisů podle něj vydaných. {uc=A}
...
#### § 30 — Zpřístupňování informací  `[272 Čl.LXVIII/23; 272 Čl.LXVIII/24]` {uc=A}
...
e) podaných žádostech o ~~závazné stanovisko~~ **vyjádření** podle § 11 odst. 2 písm. b), žádostech o povolení provozu a žádostech o vydání rozhodnutí podle § 13a po dobu 15 dnů, {uc=A}

f) ~~závazných stanoviscích~~ **vyjádřeních** vydaných podle § 11 odst. 2 písm. b), povoleních provozu a rozhodnutích podle § 13a po dobu 15 dnů, {uc=A}
...
#### § 40 — Společná ustanovení  `[272 Čl.LXVIII/25]` {uc=A}
...
~~(2) Jedná-li se o záměr vyžadující jednotné environmentální stanovisko42), závazná stanoviska podle § 11 odst. 2 písm. b) a d) se nevydávají.~~ {uc=A}

~~(3)~~ **(2)** Povolení provozu podle § 11 odst. 2 písm. c) se nevydá podle tohoto zákona, pokud je jeho vydání nahrazeno postupem v řízení o vydání integrovaného povolení podle jiného právního předpisu28). Ostatní ustanovení tohoto zákona tím nejsou dotčena. {uc=A}

~~(4)~~ **(3)** Práva a povinnosti vyplývající z rozhodnutí vydaných podle tohoto zákona provozovateli přecházejí na právní nástupce provozovatele. {uc=A}

~~(5)~~ **(4)** Ustanovení tohoto zákona a jeho prováděcích právních předpisů stanovující technické požadavky a další podmínky vztahující se na výrobky podle jiného právního předpisu jsou technickými předpisy podle tohoto jiného právního předpisu12). {uc=A}

~~(6)~~ **(5)** Na zařazování do Přechodného národního plánu a vyřazování z Přechodného národního plánu podle § 37 se nevztahuje správní řád. {uc=A}

~~(7)~~ **(6)** Provozovatel stacionárního zdroje používaného pouze k výzkumu, vývoji nebo zkoušení nových výrobků a procesů, kdy se za výzkum, vývoj nebo zkoušení nových výrobků a procesů nepovažuje tepelné zpracování odpadu, pokud je množství spalovaného odpadu vyšší než 50 tun za rok, je povinen plnit pouze povinnosti uvedené v § 17 odst. 1 písm. a), d) a e). {uc=A}
...
**1.** Řízení a postupy zahájené a neskončené přede dnem nabytí účinnosti tohoto zákona se dokončí podle zákona č. 201/2012 Sb., ve znění účinném ode dne nabytí účinnosti tohoto zákona, není-li stanoveno jinak.
...
**3.** Řízení a postupy zahájené a neskončené do dne vzniku úřadů rozvoje území krajů, k nimž je příslušný úřad rozvoje území kraje nebo jeho územní pracoviště, ode dne vzniku úřadů rozvoje území krajů převezme a dokončí příslušný úřad rozvoje území kraje nebo jeho příslušné územní pracoviště. Do dne vzniku úřadů rozvoje území krajů pokračují v těchto řízeních a postupech správní orgány příslušné podle dosavadních právních předpisů podle zákona č. 201/2012 Sb., ve znění účinném ode dne nabytí účinnosti tohoto zákona.
...
- `272 Čl.LXVIII/26` V příloze č. 10 v nadpisu části B se slovo „zastavěném“ nahrazuje slovem „zastavitelném“.
