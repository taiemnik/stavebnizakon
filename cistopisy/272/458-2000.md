...
4. elektrizační soustavou vzájemně propojený soubor zařízení pro výrobu, přenos, transformaci, ukládání a distribuci elektřiny, včetně **vývodových vedení** elektrických přípojek, přímých vedení, a systémy měřicí, ochranné, řídicí, zabezpečovací, informační a telekomunikační techniky, a to na území České republiky,
...
9. ve spolupráci s ~~Ministerstvem pro místní rozvoj~~ **Úřadem rozvoje území České republiky** a Ministerstvem pro životní prostředí dobu trvání povolovacího postupu pro zařízení na výrobu energie z obnovitelných zdrojů, jakož i jejich připojení k soustavě, včetně posouzení vlivů na životní prostředí,
...
~~(15)~~ **(14)** V prvním stupni rozhoduje v řízení Energetický regulační úřad. Rada se považuje za nadřízený správní orgán Energetického regulačního úřadu. Nadřízeným správním orgánem Rady je Rada.
...
**(10) Navrhuje-li se změna metodiky cenové regulace v průběhu regulačního období, Energetický regulační úřad zveřejní návrh změny na svých internetových stránkách a stanoví lhůtu pro podání připomínek veřejnosti, která nesmí být kratší než 30 dnů. Energetický regulační úřad umožní podávání připomínek prostřednictvím diskusního místa podle odstavce**

**3. Zveřejnění návrhu změny metodiky cenové regulace Energetický regulační úřad oznámí osobám podle odstavce 9, vyzve je k uplatnění připomínek a stanoví lhůtu pro jejich podání, která nesmí být kratší než 30 dnů. K připomínkám podaným po stanovené lhůtě se nepřihlíží.**
...
~~(11)~~ **(12)** Po veřejném projednání připomínek provede Energetický regulační úřad písemné vypořádání připomínek podaných k návrhu metodiky cenové regulace a zveřejní jej včetně jeho odůvodnění na svých internetových stránkách do 30 dnů od uskutečnění veřejného projednání. Součástí písemného vypořádání připomínek je písemný záznam o průběhu veřejného projednání.

~~(12)~~ **(13)** Energetický regulační úřad je povinen cenové výměry vydávané podle tohoto zákona, s výjimkou věcně usměrňovaných cen tepelné energie, vydat nejpozději do 30. listopadu roku předcházejícího roku, pro který v cenovém výměru Energetický regulační úřad regulované ceny stanoví. Cenové výměry týkající se věcně usměrňovaných cen tepelné energie a regulovaných cen podle zákona o podporovaných zdrojích energie je Energetický regulační úřad povinen vydat nejpozději do 30. září roku předcházejícího roku, pro který v cenovém výměru Energetický regulační úřad regulované ceny stanoví.
...
#### § 19a — Regulace cen  `[272 Čl.XLIII/19]`
...
#### § 19cb  `[272 Čl.XLIII/20]`

**Cena za kapacitní mechanismus Cenu za kapacitní mechanismus hradí účastníci trhu s elektřinou provozovateli přenosové soustavy v ceně za související služby v elektroenergetice přímo nebo prostřednictvím provozovatele regionální distribuční soustavy.**
...
#### § 27da — Povinnosti datového centra při zohledňování aktivace flexibility a ukládání elektřiny
...
5. subjektu zúčtování naměřené a vyhodnocené údaje o dodávkách a odběrech elektřiny a naměřené a vyhodnocené údaje o dodávkách a odběrech elektřiny se zohledněním aktivace flexibility **a ukládání elektřiny** v předávacím místě účastníka trhu s elektřinou ~~poskytujícího flexibilitu~~, ve kterém převzal odpovědnost za odchylku dodávky nebo odběru elektřiny nebo flexibility v době její aktivace,
...
c) s územně plánovací dokumentací, **ledaže předpokládaná výrobna elektřiny je stavbou pro energetickou bezpečnost podle zákona upravujícího urychlení výstavby strategicky významné infrastruktury,**
...
#### § 35 — Kapacitní mechanismus  `[272 Čl.XLIII/29]`
...
**(2) Ministerstvo stanoví opatřením obecné povahy podle odstavce 1 po projednání s Energetickým regulačním úřadem rovněž způsob určení rozsahu potřebné dostupnosti výkonu výroben elektřiny nebo jiných energetických zařízení.**

~~(2)~~ **(3)** Provozovatel přenosové soustavy je povinen poskytnout ministerstvu nezbytnou součinnost při stanovení podmínek kapacitního mechanismu.

~~(3)~~ **(4)** Rozsah potřebné dostupnosti ~~regulačního~~ výkonu výroben elektřiny nebo jiných energetických zařízení určuje za podmínek stanovených ministerstvem provozovatel přenosové soustavy **a předloží ho ministerstvu ke schválení**.

~~(4)~~ **(5)** Provozovatel přenosové soustavy zpracuje návrh postupu a podmínek zajištění potřebné dostupnosti ~~regulačního~~ výkonu výroben elektřiny nebo jiných energetických zařízení **v aukci** a předloží ho ministerstvu ke schválení.
...
~~(6)~~ **(7)** Ministerstvo opatření obecné povahy změní nebo zruší, pokud se změní nebo zaniknou důvody pro zavedení kapacitního mechanismu.
...
a) v ~~zastavěném~~ **zastavitelném** území podle zvláštního právního předpisu4d)**, je-li její délka do 50 m včetně,** provozovatel distribuční soustavy,

b) mimo ~~zastavěné~~ **zastavitelné** území podle zvláštního právního předpisu4d), je-li její délka do 50 m včetně, provozovatel distribuční soustavy,

c) mimo ~~zastavěné~~ **zastavitelné** území podle zvláštního právního předpisu4d), je-li její délka nad 50 m, žadatel o připojení.
...
**(14) Smlouvou o zajištění potřebné dostupnosti výkonu se účastník kapacitního mechanismu zavazuje poskytovat provozovateli přenosové soustavy dostupnost výkonu a provozovatel přenosové soustavy se zavazuje zaplatit účastníkovi kapacitního mechanismu cenu.**

~~(14)~~ **(15)** Pokud smlouva uzavřená podle odstavců 1, 2, 5 a 7 neobsahuje některou ze stanovených náležitostí, považuje se za platnou, pokud se zákazník nedovolá její neplatnosti.

~~(15)~~ **(16)** Závazek poskytovat služby údržby odběrných elektrických zařízení nebo elektrické přípojky nebo jiné obdobné služby zaniká se zánikem závazku dodávat elektřinu ze smlouvy o dodávce elektřiny nebo smlouvy o sdružených službách dodávky elektřiny, ledaže se strany dohodnou jinak.

~~(16)~~ **(17)** Nedostatek písemné formy smlouvy podle odstavců 1, 2 a 10 může namítat jen spotřebitel.
...
a) u plynovodů ~~a~~**,** plynovodních přípojek o tlakové úrovni do 4 bar včetně **s výjimkou regulačních stanic**, umístěných v ~~zastavěném~~ **zastavitelném** území obce 1 m na obě strany a umístěných mimo ~~zastavěné~~ **zastavitelné** území obce 2 m na obě strany,
...
h) u vlastní telekomunikační sítě držitele licence umístěné v ~~zastavěném~~ **zastavitelném** území obce 0,5 m na obě strany a umístěné mimo ~~zastavěné~~ **zastavitelné** území obce 1 m na obě strany.
...
#### § 79 — ~~Tepelná přípojka a předávací stanice~~ **Tepelná přípojka, předávací stanice a tepelná síť**  `[272 Čl.XLIII/42]`
...
(3) Opravy a údržbu tepelné přípojky ~~nebo~~**,** předávací stanice **nebo tepelné sítě** zajišťuje na své náklady její vlastník.
...
b) 50 000 000 Kč nebo 1 % z čistého obratu dosaženého držitelem licence za poslední ukončené účetní období, jde-li o přestupek uvedený v odstavci 1 písm. o) **nebo t)**, odstavci 2, odstavci 3 písm. a), c), e) až l) ~~nebo~~**,** n) až s**) nebo u**), odstavci 4 až 6, odstavci 7 písm. a), c), e) až p) nebo s) nebo odstavci 9 až 11, 14 nebo 16,
...
~~(7)~~ **(6)** Věcná břemena podle odstavce 1 vznikají i na stavbách ve vlastnictví osob uvedených v odstavci 1, které nejsou součástí pozemku.

~~(8)~~ **(7)** Ustanovení tohoto zákona týkající se práv a povinností z věcných břemen se použijí na věcná břemena podle tohoto ustanovení obdobně.
